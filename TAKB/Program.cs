...
//=========================Stuff n things========================\\
			...
			Console.WriteLine ("\nYour number is " + num01*num02*num03);
			Console.Write ("\nbam arn't I so shmart?");
			Console.Write ("\nYour answer: ");

			//Get the answer from the user as an answer object
			...
			if (userReturn.isYes ()) {
				...
				Console.ReadKey ();
					...
					Console.WriteLine ("Oh really? I guess ill work on that\nMoving on to division!");
					Console.ReadKey ();
...
//=========================Answer Object===========================\\
	...
	class Answer
	{
		 ...
		 * @var string
		 */
		protected string[] trueStatements = {"y", "Y", "yes", "Yes", "Sure", "sure", "yeah", "Yeah", "true", "True", "yep", "Yep", "yea", "Yea", "dope", "Dope", "zippa zappa zoobies i like boobies9"};
